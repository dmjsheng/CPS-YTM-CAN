...
void ADVTIM_DeInit(ADVTIM_TypeDef* TIMx)
{
    ...
    assert_param(IS_ADVTIM_ALL_PERIPH(TIMx)); 

    if (TIMx == TIM2)
    {
    	/* Enable TIM2 reset state */
	    RCC_PeriphResetCmd(RCC, RCC_APBPeriph_TIM2_RST, ENABLE);
		__NOP(); __NOP(); __NOP(); __NOP(); __NOP(); __NOP();
		
	    /* Release TIM2 from reset state */
    	RCC_PeriphResetCmd(RCC, RCC_APBPeriph_TIM2_RST, DISABLE);
    }
}
...
void ADVTIM_TimeBaseInit(ADVTIM_TypeDef* TIMx, ADVTIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
    ...
    tmpcr1 &= (uint16_t)(~((uint16_t)(TIM_CR1_DIR_Mask | TIM_CR1_CMS_Mask)));
    tmpcr1 |= (uint16_t)TIM_TimeBaseInitStruct->TIM_CounterMode;

    /* Set the clock division */
    tmpcr1 &= (uint16_t)(~TIM_CKD_Mask);
    tmpcr1 |= (uint16_t)TIM_TimeBaseInitStruct->TIM_ClockDivision;

    TIMx->CR1 = tmpcr1;

    /* Set the Autoreload value */
    TIMx->ARR = TIM_TimeBaseInitStruct->TIM_Period;   // 加载自动重装载寄存器

    /* Set the Prescaler value */
    TIMx->PSC = TIM_TimeBaseInitStruct->TIM_Prescaler;
			 
    /* Set the Repetition Counter value */
    //TIMx->RCR = TIM_TimeBaseInitStruct->TIM_RepetitionCounter;  // TIM2取消了此Register
...
void ADVTIM_OC1Init(ADVTIM_TypeDef* TIMx, ADVTIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    TIMx->CCER &= (uint16_t)(~(uint16_t)TIM_CCER_CC1E);  // Output disable
...
/**
  ...
  *      TIM2
  * @param  TIM_OCInitStruct: pointer to a ADVTIM_OCInitTypeDef structure
  *         that contains the configuration information for the specified TIMx peripheral.
  * @retval None
  */
void ADVTIM_OC2Init(ADVTIM_TypeDef* TIMx, ADVTIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    TIMx->CCER &= (uint16_t)(~((uint16_t)TIM_CCER_CC2E));   // Output disable
...
void ADVTIM_OC3Init(ADVTIM_TypeDef* TIMx, ADVTIM_OCInitTypeDef* TIM_OCInitStruct)
{
    ...
    /* Disable the Channel 2: Reset the CC2E Bit */
    TIMx->CCER &= (uint16_t)(~((uint16_t)TIM_CCER_CC3E));   // Output disable
...
void ADVTIM_ICInit(ADVTIM_TypeDef* TIMx, ADVTIM_ICInitTypeDef* TIM_ICInitStruct)
{
    ...
    {
        /* TI1 Configuration */
        ADVTIM_TI1_Config(TIMx, TIM_ICInitStruct->TIM_ICPolarity, TIM_ICInitStruct->TIM_ICSelection, TIM_ICInitStruct->TIM_ICFilter);
    ...
    {
        /* TI2 Configuration */
        ADVTIM_TI2_Config(TIMx, TIM_ICInitStruct->TIM_ICPolarity, TIM_ICInitStruct->TIM_ICSelection, TIM_ICInitStruct->TIM_ICFilter);
        /* Set the Input Capture Prescaler value */
    ...
    {
        /* TI3 Configuration */
        ADVTIM_TI3_Config(TIMx, TIM_ICInitStruct->TIM_ICPolarity, TIM_ICInitStruct->TIM_ICSelection, TIM_ICInitStruct->TIM_ICFilter);
        /* Set the Input Capture Prescaler value */
    ...
    {
        /* TI4 Configuration */
        ADVTIM_TI4_Config(TIMx, TIM_ICInitStruct->TIM_ICPolarity, TIM_ICInitStruct->TIM_ICSelection, TIM_ICInitStruct->TIM_ICFilter);
        /* Set the Input Capture Prescaler value */
...
void ADVTIM_PWMIConfig(ADVTIM_TypeDef* TIMx, ADVTIM_ICInitTypeDef* TIM_ICInitStruct)
{
    ...
    if (TIM_ICInitStruct->TIM_Channel == TIM_Channel_1)
    {
        ...
        /* TI2 Configuration */
        ADVTIM_TI2_Config(TIMx, icoppositepolarity, icoppositeselection, TIM_ICInitStruct->TIM_ICFilter);
        /* Set the Input Capture Prescaler value */
        ADVTIM_SetIC2Prescaler(TIMx, TIM_ICInitStruct->TIM_ICPrescaler);	
    }	
    else
    { 
        ...
        /* TI1 Configuration */
        ADVTIM_TI1_Config(TIMx, icoppositepolarity, icoppositeselection, TIM_ICInitStruct->TIM_ICFilter);
        /* Set the Input Capture Prescaler value */
        ADVTIM_SetIC1Prescaler(TIMx, TIM_ICInitStruct->TIM_ICPrescaler);
    }
}
...
{	
    ...
    TIM_TimeBaseInitStruct->TIM_Prescaler = 0x0000;   // 预分频器默认值
...
{
    /* Set the default configuration */
    TIM_BDTRInitStruct->TIM_OSSRState = TIM_OSSRState_Disable;  // Off-State Selection for Run Mode
...
/**
  * @brief  Enables or disables the specified TIMx peripheral.
  * @param  TIMx: where x can be 1 to 2 to select the TIMx peripheral.
  *   This parameter can be one of the following values:
  *      TIM2
...
/**
  ...
  *   This parameter can be one of the following values:
  *      TIM2
  * @param  TIM_IT: specifies the TIMx interrupts sources to be enabled or disabled.
  ...
  * @param  NewState: new state of the TIMx interrupts.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
void ADVTIM_InternalClockConfig(ADVTIM_TypeDef* TIMx)
{
    ...
    TIMx->SMCR &=  (uint16_t)(~((uint16_t)TIM_SMCR_SMS));  // 预分频器直接从内部时钟驱动
}
...
void ADVTIM_TIxExternalClockConfig(ADVTIM_TypeDef* TIMx, uint16_t TIM_TIxExternalCLKSource,	uint16_t TIM_ICPolarity, uint16_t ICFilter)
{
    ...
    {
        ADVTIM_TI2_Config(TIMx, TIM_ICPolarity, TIM_ICSelection_DirectTI, ICFilter);
    }
    else
    {
        ADVTIM_TI1_Config(TIMx, TIM_ICPolarity, TIM_ICSelection_DirectTI, ICFilter);
    }
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg TIM_ForcedAction_Active: Force active level on OC1REF/强制为有效电平（强制OC1REF为高）
  *     @arg TIM_ForcedAction_InActive: Force inactive level on OC1REF/强制为无效电平（强制OC1REF为低）
  * @retval None
  */
...
/**
  ...
  * @param  TIM_ForcedAction: specifies the forced Action to be set to the output waveform.
  *   This parameter can be one of the following values:
  *     @arg TIM_ForcedAction_Active: Force active level on OC2REF/强制为有效电平（强制OC2REF为高）
  *     @arg TIM_ForcedAction_InActive: Force inactive level on OC2REF./强制为无效电平（强制OC2REF为低）
  * @retval None
  */
...
/**
  ...
  * @param  TIM_ForcedAction: specifies the forced Action to be set to the output waveform.
  *   This parameter can be one of the following values:
  *     @arg TIM_ForcedAction_Active: Force active level on OC3REF/强制为有效电平（强制OC3REF为高）
  *     @arg TIM_ForcedAction_InActive: Force inactive level on OC3REF./强制为无效电平（强制OC3REF为低）
  * @retval None
  */
...
/**
  ...
  * @param  TIM_ForcedAction: specifies the forced Action to be set to the output waveform.
  *   This parameter can be one of the following values:
  *     @arg TIM_ForcedAction_Active: Force active level on OC4REF/强制为有效电平（强制OC4REF为高）
  *     @arg TIM_ForcedAction_InActive: Force inactive level on OC4REF./强制为无效电平（强制OC4REF为低）
  * @retval None
  */
...
void ADVTIM_ARRPreloadConfig(ADVTIM_TypeDef* TIMx, FunctionalState NewState)
{
    ...
    if (NewState != DISABLE)
    {
        ...
        TIMx->CR1 |= TIM_CR1_ARPE;  // 自动重装载预装载允许
    }
    else
    {
...
/**
  * @brief  Selects the TIMx peripheral Commutation event.
  * @param  TIMx: where x can be 1 to 2 to select the TIMx peripheral.
  *   This parameter can be one of the following values:
  *      TIM2
...
/**
  * @brief  Enables or disables the TIMx Capture Compare Channel xN.
  * @param  TIMx: where x can be 1 to 2 to select the TIMx peripheral.
  *   This parameter can be one of the following values:
  *      TIM2
  * @param  TIM_Channel: specifies the TIM Channel
...
/**
  * @brief  Checks whether the TIMx interrupt has occurred or not.
  * @param  TIMx: where x can be 1 to 2 to select the TIMx peripheral.
  *   This parameter can be one of the following values:
  *      TIM2
...
ITStatus ADVTIM_GetITStatus(ADVTIM_TypeDef* TIMx, uint16_t TIM_IT)
{
    ...
    itstatus = TIMx->SR & TIM_IT;    // 获取中断标志
    itenable = TIMx->DIER & TIM_IT;  // 获取中断使能状态
...
/**
  ...
  *   This parameter can be any combination of the following values:
  *     @arg TIM_IT_Update: TIMx update Interrupt source
  *     @arg TIM_IT_CC1: TIM Capture Compare 1 Interrupt source
  *     @arg TIM_IT_CC2: TIM Capture Compare 2 Interrupt source
  *     @arg TIM_IT_CC3: TIM Capture Compare 3 Interrupt source
  *     @arg TIM_IT_CC4: TIM Capture Compare 4 Interrupt source
...
/**
  ...
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 1 is selected to be connected to TI1.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 1 is selected to be connected to TI2.
...
void ADVTIM_TI1_Config(ADVTIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
    ...
    /* Disable the Channel 1: Reset the CC1E Bit */
    TIMx->CCER &= (uint16_t)~((uint16_t)TIM_CCER_CC1E);  // capture disable
    tmpccmr1 = TIMx->CCMR1;
    tmpccer  = TIMx->CCER;
    /* Select the Input and set the filter */
    tmpccmr1 &= (uint16_t)(((uint16_t)~((uint16_t)TIM_CCMR1_CC1S)) & ((uint16_t)~((uint16_t)TIM_CCMR1_IC1F)));
    tmpccmr1 |= (uint16_t)(TIM_ICSelection << 0);
    tmpccmr1 |= (uint16_t)(TIM_ICFilter << 4);
  
    /* Select the Polarity and set the CC1E Bit */
    tmpccer &= (uint16_t)~((uint16_t)(TIM_CCER_CC1P));   // 上升沿捕获
    tmpccer |= (uint16_t)(TIM_ICPolarity | (uint16_t)TIM_CCER_CC1E);  // 配置捕获边沿及使能捕获 
...
/**
  ...
  * @param  TIM_ICSelection: specifies the input to be used.
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 2 is selected to be connected to TI2.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 2 is selected to be connected to TI1.
...
void ADVTIM_TI2_Config(ADVTIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,	uint16_t TIM_ICFilter)
{
    ...
    /* Disable the Channel 2: Reset the CC2E Bit */
    TIMx->CCER &= (uint16_t)~((uint16_t)TIM_CCER_CC2E);  // capture disable
    tmpccmr1 = TIMx->CCMR1;
    tmpccer  = TIMx->CCER;
    ...
    tmpccer &= (uint16_t)~((uint16_t)(TIM_CCER_CC2P));    // 上升沿捕获
    tmpccer |= (uint16_t)(tmp | (uint16_t)TIM_CCER_CC2E);   // 配置捕获边沿及使能捕获 
...
/**
  ...
  * @param  TIM_ICSelection: specifies the input to be used.
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 3 is selected to be connected to TI3.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 3 is selected to be connected to TI4.
...
void ADVTIM_TI3_Config(ADVTIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection,	uint16_t TIM_ICFilter)
{
    ...
    TIMx->CCER &= (uint16_t)~((uint16_t)TIM_CCER_CC3E);   // capture disable
    tmpccmr2 = TIMx->CCMR2;
    tmpccer  = TIMx->CCER;
    tmp = (uint16_t)(TIM_ICPolarity << 8);
    /* Select the Input and set the filter */
    tmpccmr2 &= (uint16_t)(((uint16_t)~((uint16_t)TIM_CCMR2_CC3S)) & ((uint16_t)~((uint16_t)TIM_CCMR2_IC3F)));
    tmpccmr2 |= (uint16_t)(TIM_ICSelection << 0);
    tmpccmr2 |= (uint16_t)(TIM_ICFilter << 4);
    
    /* Select the Polarity and set the CC3E Bit */
    tmpccer &= (uint16_t)~((uint16_t)(TIM_CCER_CC3P));    // 上升沿捕获
    tmpccer |= (uint16_t)(tmp | (uint16_t)TIM_CCER_CC3E);  // 配置捕获边沿及使能捕获 
...
/**
  ...
  * @param  TIM_ICSelection: specifies the input to be used.
  *   This parameter can be one of the following values:
  *     @arg TIM_ICSelection_DirectTI: TIM Input 4 is selected to be connected to TI4.
  *     @arg TIM_ICSelection_IndirectTI: TIM Input 4 is selected to be connected to TI3.
...
void ADVTIM_TI4_Config(ADVTIM_TypeDef* TIMx, uint16_t TIM_ICPolarity, uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
    ...
    tmpccer &= (uint16_t)~((uint16_t)(TIM_CCER_CC4P));   // 上升沿捕获
    tmpccer |= (uint16_t)(tmp | (uint16_t)TIM_CCER_CC4E);  // 配置捕获边沿及使能捕获 
